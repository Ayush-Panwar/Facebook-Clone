...
export default function RegisterForm({ setVisible }) {
  ...
  const registerValidationSchema = Yup.object({
    first_name: Yup.string()
      ...
      .matches(/^[aA-zZ\s]+$/, "Numbers and special charcters are not allowed"),
        ...
        <Formik
          ...
          onSubmit={() => {
            ...
            if (current_date - picked_date < atleast14) {
              setDateError(
                "It looks like you have entered a wrong info.Please make sure that you use your real date of birth."
              );
            } else if (current_date - picked_date > noMoreThan70) {
              setDateError(
                "Its looks like you have entered a wrong info.Please make sure that you use your real date of birth"
              );
            } else if (gender === "") {
              setDateError("");
              setGenderError(
          ...
          {(formik) => (
            <Form className="register_form">
              ...
              <div className="reg_infos">
                By clicking Sign Up,you can agree to our {""}
                <span>Terms, Data Policy.</span> and <span>Cookie Policy</span>.
                You may receive SMS notification from us and can opt out at any
                time.
              </div>
